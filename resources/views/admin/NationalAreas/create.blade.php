...
<nav aria-label="breadcrumb" class="main-breadcrumb" style="margin-top:-35px;">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route('nationalareas.index')}}">National Areas</a></li>
...
<div class="card card-info card-outline">
    <div class="card-header">
      <h2 class="card-title font-weight-bold">
        ...
        Create National Area
      </h2>
    </div>
<div class="card-body">   
<form action="{{route('nationalareas.store')}}" method="POST" enctype="multipart/form-data">
  @csrf
