              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{$candidate->user->image?url('images/userImages',$candidate->user->image):'https://bootdey.com/img/Content/avatar/avatar7.png'}}" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>{{$candidate->user->name}}</h4>
                      <p class="text-secondary mb-1">{{$candidate->user->email}}</p>
